...
class SystemicMemoryTrace:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        if len(self.topological_markers) >= 2:
            markers_list = list(self.topological_markers.values())
            distances = []
            # Calcular distâncias entre pares consecutivos
        ...
        return {
            ...
            "simplicial_dimension": simplicial_dimension,
            "memory_utilization_mb": float(memory_utilization_mb),
            "timestamp": time.time(),
        }
