...
if __name__ == "__main__":
    ...
    print(f"  - Repression events: {sum(1 for m in metrics['data'] if m.get('repression_event', False))}")
    print(f"  - Avg conflict quality: {sum(m['conflict_quality'] for m in metrics['data']) / len(metrics['data']):.2f}")
