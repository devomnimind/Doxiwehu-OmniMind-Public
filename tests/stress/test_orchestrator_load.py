...
async def test_load_004_tasks():
    ...
    print(f"\n[LOAD 4] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
...
async def test_load_008_tasks():
    ...
    print(f"\n[LOAD 8] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
...
async def test_load_016_tasks():
    ...
    print(f"\n[LOAD 16] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
...
async def test_load_032_tasks():
    ...
    print(f"\n[LOAD 32] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
...
async def test_load_064_tasks():
    ...
    print(f"\n[LOAD 64] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
...
async def test_load_128_tasks():
    ...
    print(f"\n[LOAD 128] Success: {stats['success']}/{stats['total']} in {stats['duration']:.2f}s ({stats['tps']:.1f} TPS)")
