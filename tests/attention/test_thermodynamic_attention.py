...
class TestMultiHeadThermodynamicAttention:
    ...
    def test_initialization(self) -> None:
        ...
        attention = MultiHeadThermodynamicAttention(embed_dim=64, num_heads=8)
    ...
    def test_forward_pass(self) -> None:
        ...
        attention = MultiHeadThermodynamicAttention(embed_dim=64, num_heads=4)
...
class TestIntegration:
    ...
    def test_attention_output_depends_on_entropy(self) -> None:
        ...
        attention = ThermodynamicAttention(embed_dim=32, entropy_weight=10.0)
