...
def test_sandbox_disabled_without_artifacts(tmp_path):
    sandbox = FirecrackerSandbox(kernel_path=None, rootfs_path=None, enabled=True)
...
def test_sandbox_executes_with_dummy_images(tmp_path):
    ...
    payload = {"task": "critical", "plan": "firecracker"}
