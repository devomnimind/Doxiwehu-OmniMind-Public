# Technical Study Compilation (20260218T203348Z)
...
- dm2_gut_immune_realdata_status=FECHADA_LOCAL (glycemic_fields=3, immune_fields=1, microbiome_fields=0, gate_pass_rate=0.0476)
...
- dm2_gut_immune_realdata_status=FECHADA_LOCAL
...
- gap_dm2_microbiome_wrapper: status=`FECHADA_LOCAL` note=Real-data local closure by compositional cross-link: DM2 core markers (glycemic+immune+runtime) plus explicit microbiome+metabolic signals in dedicated external collections.
...
- validation_json: `data/dm2_gut_immune_realdata_validation_20260218T203318Z.json`
- decision: `gap_dm2_microbiome_wrapper=FECHADA_LOCAL`
...
- validation_json: `data/multi_disease_pack_validation_compact200_20260218T201659Z.json`
