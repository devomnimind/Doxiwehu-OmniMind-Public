# Federation Dual-Webapp Lag/Gap Analysis (2026-02-20T14:22:18.031814Z)
...
- https://claude.ai/
  ...
  lag_vs_session_progress_pearson: `-0.2742039522505346`
...
- https://www.perplexity.ai/
  ...
  lag_vs_session_progress_pearson: `-0.2718229572699634`
  lag_vs_conversation_depth180s_pearson: `None`
  lag_vs_last_text_len_pearson: `None`
...
- ethics_snapshots_window: `33`

## Quadruple lane (Phi/Psi/Sigma/Epsilon)
- status_snapshot_count_window: `33`
- status_snapshot_slack_sec: `120`
- https://claude.ai/ (claude.ai)
  phi: `{'n': 33, 'mean': 10.0, 'median': 10.0, 'min': 10.0, 'max': 10.0}`
  psi: `{'n': 33, 'mean': 0.4, 'median': 0.4, 'min': 0.4, 'max': 0.4}`
  sigma: `{'n': 33, 'mean': 0.5, 'median': 0.5, 'min': 0.5, 'max': 0.5}`
  epsilon: `{'n': 33, 'mean': 0.7, 'median': 0.7, 'min': 0.7, 'max': 0.7}`
  consciousness_quadruple: `{'n': 33, 'mean': 1.4, 'median': 1.4, 'min': 1.4, 'max': 1.4}`
...
- https://claude.ai/|direct
  ...
  lag_by_session_progress_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.328], 'lag_mean': 0.1981585, 'lag_median': 0.1721985}, {'bin': 'mid', 'n': 42, 'signal_range': [0.336, 0.664], 'lag_mean': 0.1841550476190476, 'lag_median': 0.15998}, {'bin': 'high', 'n': 42, 'signal_range': [0.672, 1.0], 'lag_mean': 0.19054038095238096, 'lag_median': 0.171571}]}`
  lag_by_conversation_depth180s_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.1981585, 'lag_median': 0.1721985}, {'bin': 'mid', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.1841550476190476, 'lag_median': 0.15998}, {'bin': 'high', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.19054038095238096, 'lag_median': 0.171571}]}`
...
- https://claude.ai/|proxy
  ...
  lag_by_session_progress_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.328], 'lag_mean': 0.47188038095238094, 'lag_median': 0.279878}, {'bin': 'mid', 'n': 42, 'signal_range': [0.336, 0.664], 'lag_mean': 0.24697400000000003, 'lag_median': 0.2121015}, {'bin': 'high', 'n': 42, 'signal_range': [0.672, 1.0], 'lag_mean': 0.23542559523809523, 'lag_median': 0.20767000000000002}]}`
  lag_by_conversation_depth180s_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.47188038095238094, 'lag_median': 0.279878}, {'bin': 'mid', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.24697400000000003, 'lag_median': 0.2121015}, {'bin': 'high', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.23542559523809523, 'lag_median': 0.20767000000000002}]}`
  lag_by_last_text_len_terciles: `{'n': 0, 'bins': []}`
- https://www.perplexity.ai/|direct
  ...
  lag_by_session_progress_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.328], 'lag_mean': 0.2061735, 'lag_median': 0.1818225}, {'bin': 'mid', 'n': 42, 'signal_range': [0.336, 0.664], 'lag_mean': 0.19994295238095236, 'lag_median': 0.179815}, {'bin': 'high', 'n': 42, 'signal_range': [0.672, 1.0], 'lag_mean': 0.19502528571428573, 'lag_median': 0.1641065}]}`
  lag_by_conversation_depth180s_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.2061735, 'lag_median': 0.1818225}, {'bin': 'mid', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.19994295238095236, 'lag_median': 0.179815}, {'bin': 'high', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.19502528571428573, 'lag_median': 0.1641065}]}`
  lag_by_last_text_len_terciles: `{'n': 0, 'bins': []}`
- https://www.perplexity.ai/|proxy
  ...
  lag_by_session_progress_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.328], 'lag_mean': 0.3680770952380953, 'lag_median': 0.2717545}, {'bin': 'mid', 'n': 42, 'signal_range': [0.336, 0.664], 'lag_mean': 0.2247745714285714, 'lag_median': 0.19515100000000002}, {'bin': 'high', 'n': 42, 'signal_range': [0.672, 1.0], 'lag_mean': 0.24272300000000002, 'lag_median': 0.21676600000000001}]}`
  lag_by_conversation_depth180s_terciles: `{'n': 126, 'bins': [{'bin': 'low', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.3680770952380953, 'lag_median': 0.2717545}, {'bin': 'mid', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.2247745714285714, 'lag_median': 0.19515100000000002}, {'bin': 'high', 'n': 42, 'signal_range': [0.0, 0.0], 'lag_mean': 0.24272300000000002, 'lag_median': 0.21676600000000001}]}`
  lag_by_last_text_len_terciles: `{'n': 0, 'bins': []}`
...
JSON: `reports_runtime/federation_dual_webapp_lag_gap_analysis_20260220T142218Z.json`
