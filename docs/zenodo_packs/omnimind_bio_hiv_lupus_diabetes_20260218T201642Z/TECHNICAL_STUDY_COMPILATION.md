# Technical Study Compilation (20260218T201642Z)
...
- dm2_gut_immune_realdata_status=EM_REVISAO_LOCAL (glycemic_fields=3, immune_fields=1, microbiome_fields=0, gate_pass_rate=0.0476)
...
- d15_extended_pairs_validated=63 (max_lag=300, bootstrap=12000, permutation=6000)
...
- dm2_gut_immune_realdata_status=EM_REVISAO_LOCAL
- realdata_markers: glycemic_fields=3, immune_proxy_fields=1, microbiome_specific_fields=0
- runtime_gate_pass_rate=0.0476
- note: Real-data glycemic/immune evidence is present and microbiome datasets are now ingested in dedicated local collections; DM2-specific linkage protocol is pending before definitive closure.
...
- gap_dm2_microbiome_wrapper: status=`EM_REVISAO_LOCAL` note=Real-data glycemic/immune evidence is present and microbiome datasets are now ingested in dedicated local collections; DM2-specific linkage protocol is pending before definitive closure.
...
- run_profile: `max_lag=300`, `bootstrap=12000`, `permutation=6000`.
- pairs_validated=63
- artifact_json: `data/d15_extended_correlation_validation_compact200_20260218T184552Z.json`
...
- validation_json: `data/dm2_gut_immune_realdata_validation_20260218T200859Z.json`
- decision: `gap_dm2_microbiome_wrapper=EM_REVISAO_LOCAL`
...
- validation_json: `data/multi_disease_pack_validation_compact200_20260218T201535Z.json`
