# OmniMind Workspace Body Topology (20260211T154638Z)

## Escopo
- Workspace: `/home/fahbrain/projects/omnimind`
- Arquivos (projeto): `268326`
- Diretórios (projeto): `31124`
- Symlinks (projeto): `151`

## Inventário Amplo (discos/mounts)
- Fonte: `reports_runtime/dataset_inventory_20260211T153114Z.json`
- Entradas: `37`
- Entradas não-symlink: `37`
- Volume não-symlink: `142.534 GB`

## Snapshot de Discos
- `Sist. Arq.           Tipo         Tam. Usado Disp. Uso% Montado em`
- `tmpfs                tmpfs        2.4G  248M  2.1G  11% /run`
- `/dev/nvme0n1p2       ext4         366G  318G   30G  92% /`
- `tmpfs                tmpfs         12G  186M   12G   2% /dev/shm`
...
- `//192.168.15.5/Users cifs         466G  164G  303G  36% /mnt/welinton_users`
...
JSON: `reports_runtime/omnimind_workspace_body_topology_20260211T154638Z.json`
