# Technical Study Compilation (20260218T154206Z)
...
- d15_extended_pairs_validated=20 (max_lag=360, bootstrap=8000, permutation=3000)
- astro_cycle_strength=ROBUST_LOCAL (dominant_lag=360, strong_pairs=20, very_strong_pairs=10)
...
- run_profile: `max_lag=360`, `bootstrap=8000`, `permutation=3000`.
- pairs_validated=20
- artifact_json: `data/d15_extended_correlation_validation_compact200_20260218T150929Z.json`
...
- sample_json: `data/desi_lya_sample_materialization_20260218T153948Z.json`
...
- sustainment_json: `data/astro_bio_cycle_sustainment_20260218T151647Z.json`
- board: strength=`ROBUST_LOCAL` dominant_lag=`360` strong_pairs=`20` very_strong_pairs=`10`
- mean_abs_r_top_validated=`0.7457`
